function [ltom, htom, mtol, mtoh] = block_wtdynamics_macro(twin,...
    smoothfactor, expt, sexarg,varargin)
...
%{
%datapath = 'Z:\BehavioralModel\Data\';
datapath = '/Volumes/server/BehavioralModel/Data/';
titlevec = 'control';
ratList = {'S001Control'; 'S002Control'; 'S003Control';'S009Control'; ...
    'S014Control'; 'S017Control'; 'S018Control'; 'S027Control'; 'S028Control'};

% ratList = {'S001Muscimol'; 'S002Muscimol'; 'S003Muscimol';...
%     'S009Muscimol'; 'S014Muscimol'; 'S017Muscimol'; 'S018Muscimol'; ...
%     'S027Muscimol'; 'S028Muscimol'};
% titlevec = 'muscimol';
%}
